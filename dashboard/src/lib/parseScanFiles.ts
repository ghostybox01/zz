...
export const SCAN_FILES: readonly ScanFileSchema[] = [
  ...
  },
  {
    ...
    hasSourceUrl: true,
    trailingFields: 3,
    toDetail: (_u, [_keyType, mode, key]) => `[${mode ?? '?'}] ${maskOne(key)}`,
  },
  {
  ...
  },
  {
    ...
    hasSourceUrl: true,
    trailingFields: 5,
    toDetail: (_u, [host, port, user, _pass]) => `${host}:${port} · ${user} · ***`,
  },
  {
  ...
  },
  {
    ...
    provider: 'Mailjet',
    severity: 'medium',
    ruleLabel: 'Mailjet API key + secret',
    hasSourceUrl: true,
    trailingFields: 2,
    toDetail: (_u, [k, s]) => `${k} · ${maskOne(s)}`,
  },
  {
    ...
    provider: 'Plivo',
    severity: 'medium',
    ruleLabel: 'Plivo Auth ID + token',
    hasSourceUrl: true,
    trailingFields: 2,
    toDetail: (_u, [id, tok]) => `${id} · ${maskOne(tok)}`,
  },
  {
    file: 'valid_heroku.txt',
    provider: 'Heroku',
    severity: 'high',
    ruleLabel: 'Heroku API key',
    hasSourceUrl: true,
    trailingFields: 1,
    toDetail: (_u, [t]) => maskOne(t),
  },
  ...
  {
    file: 'NPM_Token_found.txt',
    provider: 'NPM',
    severity: 'medium',
    ruleLabel: 'NPM access token',
    hasSourceUrl: true,
    trailingFields: 1,
    toDetail: (_u, [t]) => maskOne(t),
  },
  {
    file: 'Cloudflare_Global_found.txt',
    provider: 'Cloudflare',
    severity: 'high',
    ruleLabel: 'Cloudflare Global API key',
    hasSourceUrl: true,
    trailingFields: 1,
    toDetail: (_u, [t]) => maskOne(t),
  },
  {
    file: 'DigitalOcean_PAT_found.txt',
    provider: 'DigitalOcean',
    severity: 'high',
    ruleLabel: 'DigitalOcean personal access token',
    hasSourceUrl: true,
    trailingFields: 1,
    toDetail: (_u, [t]) => maskOne(t),
  },
  {
    file: 'GitLab_PAT_found.txt',
    provider: 'GitLab',
    severity: 'high',
    ruleLabel: 'GitLab personal access token',
    hasSourceUrl: true,
    trailingFields: 1,
    toDetail: (_u, [t]) => maskOne(t),
  },
  {
    file: 'Slack_Bot_Token_found.txt',
    provider: 'Slack',
    severity: 'medium',
    ruleLabel: 'Slack bot token (xoxb-…)',
    hasSourceUrl: true,
    trailingFields: 1,
    toDetail: (_u, [t]) => maskOne(t),
  },
